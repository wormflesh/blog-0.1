<template>
    <div id="layout-header" :class="{'fixed':fixed,'hidden':hidden}" @click.stop="mobileShow=false">
        <div class="site-logo">
            <router-link to="/">
                <img src="@/assets/logo/WormFlesh.svg" alt="">
                <!-- <p class="site-name">WormFlesh</p> -->
            </router-link>
        </div>
        ...
        <div class="site-menus" :class="{'mobileShow':mobileShow}" @click.stop="mobileShow=!mobileShow">
            ...
            <div class="menu-item hasChild">
                <a href="#">文章</a>
                <div class="childMenu">
                    <div class="sub-menu" v-for="item in category" :key="item.cate_name"><router-link :to="`/category/${item.cate_name}`">{{item.cate_name}}</router-link></div>
                </div>
            </div>
