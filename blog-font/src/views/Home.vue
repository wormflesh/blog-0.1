        ...
        <div class="site-content animate">
            ...
            <main class="site-main" :class="{'search':hideSlogan}">
                ...
                <template v-for="item in postList">
                    <post :post="item" :key="item.article.art_id"></post>
                </template>
            </main>
...
<script>
    ...
    import {fetchFeature, fetchPage} from '../api'
    ...
    export default {
        ...
        methods: {
            ...
            fetchPage() {
                fetchPage(this.currPage).then(res => {
            ...
            loadMore() {
                fetchPage(this.currPage+1).then(res => {
